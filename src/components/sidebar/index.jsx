  ...
  return (
    <>
      <div className="flex flex-col flex-1 h-0 bg-white border-r border-gray-200">
          ...
          <nav className="flex-1 px-2 mt-5 bg-white">
            <div className="space-y-1">
              ...
              <div className="pt-4 pb-2">
                <p className="px-2 text-sm text-gray-500">Reports</p>
              </div>
              ...
              <Link href="/elevation-chart">
                {({ active }) => (
                  ...
                  >
                    <span className="truncate">Elevation Chart</span>
                    {collection?.["elevation-chart"]?.length && (
                      <span
                        className={clsx(
                          active ? "bg-white" : "bg-gray-100 text-gray-600 group-hover:bg-gray-200",
                          "ml-auto inline-block py-0.5 px-3 text-xs rounded-full"
              ...
              <Link href="/pressure-relief-positioning-chart">
                {({ active }) => (
                  <a
                    className={clsx(
                      "flex items-center px-2 py-3 sm:py-2 text-sm font-medium leading-5 transition duration-150 ease-in-out rounded-md group focus:outline-none",
                  ...
                  >
                    <span className="truncate">Pressure Relief Positioning Chart</span>
                    {collection?.["pressure-relief-positioning-chart"]?.length && (
                      <span
                        className={clsx(
                          active ? "bg-white" : "bg-gray-100 text-gray-600 group-hover:bg-gray-200",
                          "ml-auto inline-block py-0.5 px-3 text-xs rounded-full"
              ...
              <Link href="/paediatric-tracheostomy-safety-checklist">
                {({ active }) => (
                  <a
                    className={clsx(
                      "flex items-center px-2 py-3 sm:py-2 text-sm font-medium leading-5 transition duration-150 ease-in-out rounded-md group focus:outline-none",
                  ...
                  >
                    <span className="truncate">Paediatric Tracheostomy Safety Checklist</span>
                    {collection?.["paediatric-tracheostomy-safety-checklist"]?.length && (
                      <span
                        className={clsx(
                          active ? "bg-white" : "bg-gray-100 text-gray-600 group-hover:bg-gray-200",
                          "ml-auto inline-block py-0.5 px-3 text-xs rounded-full"
              ...
              <Link href="/body-map">
                {({ active }) => (
                  ...
                  >
                    <span className="truncate">Body Map</span>
                    {collection?.["body-map"]?.length && (
                      <span
                        className={clsx(
                          active ? "bg-white" : "bg-gray-100 text-gray-600 group-hover:bg-gray-200",
                          "ml-auto inline-block py-0.5 px-3 text-xs rounded-full"
        ...
        <div className="flex flex-col flex-shrink-0 w-full px-2 py-4 space-y-1">
          <Link href="/settings">
            {({ active }) => (
              <a
                className={clsx(
