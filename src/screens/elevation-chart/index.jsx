...
function ElevationChart() {
  ...
  return (
    <Screen title="Elevation Charts">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <label htmlFor="duration" className="block text-sm font-medium text-gray-700">
                          How long was this position manitained for?
                        </label>
                        <p className="mt-0.5 text-xs italic text-gray-600">
                      ...
                      <div>
                        <label htmlFor="reason" className="block text-sm font-medium text-gray-700">
                          If unable to elevate above 30°, why?
                        </label>
                        <p className="mt-0.5 text-xs italic text-gray-600">
                          For example, JM told me that it hurt to be in this position and requested to stop.
                        </p>
                        <textarea rows="3" name="reason" id="reason" ref={register()} className="w-full mt-1" />
                      </div>
      ...
      <LayoutContent title="Elevation Charts">
            ...
            <div className="relative max-w-4xl mx-auto md:px-8 xl:px-0">
              <div className="pt-10 pb-16">
                <div className="flex items-center justify-between px-4 sm:px-6 md:px-0">
                  <h1 className="text-3xl font-extrabold leading-9 text-gray-900">Elevation Chart</h1>
                              ...
                              <div className="overflow-hidden border border-gray-200">
                                <table className="min-w-full divide-y divide-gray-200">
                                  ...
                                  <tbody className="bg-white divide-y divide-gray-200">
                                    {(collection["elevation-chart"] || []).map((item) => (
                                      <tr key={item._id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-no-wrap">
                                          {item.angle && (
                                            <Fragment>
                                              <span className="text-sm text-gray-900">{item.angle}</span>
                                        ...
                                        <td className="px-6 py-4 whitespace-no-wrap">
                                          {item.reason && <span className="text-sm text-gray-900">{item.reason}</span>}
