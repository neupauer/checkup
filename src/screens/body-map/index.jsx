...
function BodyMap({}) {
  ...
  return (
    <Screen title="Body Map Reports">
      <LayoutContent title="Body Map Reports">
            ...
            <div className="relative max-w-4xl mx-auto md:px-8 xl:px-0">
              <div className="pt-10 pb-16">
                <div className="flex items-center justify-between px-4 sm:px-6 md:px-0">
                  <h1 className="text-3xl font-extrabold leading-9 text-gray-900">Body Map Reports</h1>
                  <Link href="/body-map/create">
                    {({ active }) => (
                                      ...
                                      <tr key={map.id}>
                                        <td className="px-6 py-4 whitespace-no-wrap">
                                          <div className="flex items-center">
                                            <div className="">
                                              <div className="text-sm leading-5 text-gray-900">{map["date"]}</div>
                                            </div>
                                          </div>
                                        </td>

                                        <td className="px-6 py-4 text-sm font-medium leading-5 text-right whitespace-no-wrap">
                                          <Link href={`/body-map/show/${map.id}`}>
