...
function Reports({}) {
  ...
  return (
    <Screen title="Create | Reports">
      <LayoutContent title="Create | Reports">
            ...
            <div className="relative max-w-4xl mx-auto md:px-8 xl:px-0">
              <div className="pt-10 pb-16">
                <div className="flex items-center px-4 sm:px-6 md:px-0">
                  ...
                  <h1 className="ml-2 text-3xl font-extrabold leading-9 text-gray-900">Create Daily Report</h1>
                </div>
                          ...
                          <div className="">
                            <div className="lg:grid lg:grid-cols-5 lg:gap-6">
                              <div className="lg:col-span-2">
                                <label htmlFor="communication" className="text-lg font-medium leading-6 text-gray-900">
                                  Communication
                                </label>
                              ...
                              <div className="mt-5 lg:mt-0 lg:col-span-3">
                                <div className="">
                                  ...
                                  {errors.communication && (
                                    <p class="mt-1 text-xs italic text-red-600" role="alert">
                          ...
                          <div className="">
                            <div className="lg:grid lg:grid-cols-5 lg:gap-6">
                              <div className="lg:col-span-2">
                                ...
                                <p className="mt-1 text-sm leading-5 text-gray-500">
                                  If so, to whom, what, when what was the outcome? All falls and changes to skin should
                                  be reported by phone to the office asap.
                                </p>
                              </div>
                              <div className="mt-5 lg:mt-0 lg:col-span-3">
                                <div className="">
